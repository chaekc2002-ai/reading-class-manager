...
본 표준안은 교사가 직접 개발하여 교육 활동에 활용하는 소프트웨어가 학습지원 소프트웨어 선정 기준(교육부)의 필수 요건을 충족하도록 돕기 위해 작성되었습니다.

**독서꾸믈**(이하 '본 서비스')은(는) 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
* **학생 회원 가입 및 관리:** 학급 구성원 식별, 독서 활동 및 퀴즈 진도율 확인, 교사의 피드백 제공
* **서비스 제공:** 독서 기록 저장, 퀴즈 출제 및 풀이 이력 관리, 경험치(XP) 부여 등
...
* **수집 항목:** 교사 이메일 및 이름(Google 로그인), 학생 이름, 학생 PIN 번호, 학급 정보(학년, 반 등)
...
* **비밀번호 암호화:** 학생의 PIN 번호 등 중요 정보는 일방향 암호화(Hash) 되어 저장 및 관리되며, 개발자(관리자)도 알 수 없습니다. 
* **해킹 등에 대비한 기술적 대책:** 보안 인증을 획득한 전문 클라우드 플랫폼(예: Google Firebase / Vercel)을 기반으로 운영되며, 전 구간 보안 통신(HTTPS)을 사용하여 데이터를 암호화하여 전송합니다. 
...
② 권리 행사는 서비스 내 기능을 통하여 즉시 가능하며, 또는 개발 교사에게 구두나 서면으로 요청하면 지체 없이 조치하겠습니다. 
...
* **소속:** [서울장위초등학교]
* **직위:** 교사
* **연락처:** [02-942-1772] (※ 개인정보보호를 위해 교사의 개인 휴대전화 번호는 기재하지 않습니다.)
